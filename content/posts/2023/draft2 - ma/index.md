...
##### 富邦證券-客群經營
_**『以客戶為中心』導入分眾經營模式透過大數據分析應用與結合智能化數位服務滿足差異客戶需求，增加客戶跨商品往來提升整體效益成長**_
...
(提交履歷的時候沒檢查，結果台新複製過去的資料沒改到，上面還寫著*希望能夠在數位金融儲備菁英計劃結束後進入**台新**相關部門工作*...)
### 南山
#### 儲備菁英計畫
...
公司顧問總是在反應研究報告或相關資訊搜尋困難

請描述您在工作中印象最深刻的領導經驗

我在現任公司擔任IT Manager，負責建置資料搜尋引擎，讓公司顧問能夠快速方便地查詢金融機構的研究報告。這是一個具有挑戰性和創新性的專案，因為需要處理大量的中英文報告，並且自動辨識出相關的標的、產業和看法。我在這個專案中發揮了領導力，從研究如何利用ChatGPT新增功能改善流程，到開會探詢需求，再到帶領同仁開發和測試系統。我不斷地與各部門溝通協調，確保專案的進度和品質，並且解決遇到的各種問題。我也鼓勵和支持我的團隊成員，讓他們能夠發揮自己的專長和創意。最後，我成功地完成了這個專案，並且獲得了公司和顧問的高度評價。

請描述過去與他人的合作經驗、你在團隊中所扮演的角色以及你如何幫助團隊解決問題或達成目標

我在過去的工作中，常常需要與不同部門或外部合作夥伴合作，完成各種IT相關的專案。我在團隊中通常扮演的角色是技術負責人或專案管理者，負責規劃、執行和監督專案的各個階段。我也會主動與其他團隊成員分享我的知識和經驗，幫助他們提升自己的技能和效率。我認為合作是一種互相學習和成長的過程，所以我很重視團隊精神和溝通能力。我會傾聽和尊重其他人的意見和建議，並且提出自己的想法和解決方案。我也會積極參與團隊討論和決策，並且承擔自己的責任和義務。我相信只有通過有效的合作，才能夠解決問題或達成目標。




在過去的工作中，我有一次印象深刻的領導經驗是在我擔任IT Manager的時候，我帶領團隊建置了一個資料搜尋引擎，讓公司的顧問能夠快速地找到相關的研究報告或資訊。這個引擎支援中文和英文的查詢，並且利用了ChatGPT這個先進的自然語言處理技術來分析報告的內容和相關性。我使用了STAR法則來描述這個過程：

Situation: 在現任公司，顧問們經常需要搜尋特定金融機構對某議題、產業或標的的看法，但是公司沒有一個統一的平台來存放和管理這些報告，而是分散在共享Email inbox裡。這樣不僅效率低下，而且無法在非上班時間提供服務。因此，公司需要一個能夠自動化、智能化、24/7運行的資料搜尋引擎。

Task: 我的任務是設計和開發這個引擎，並且確保它能夠準確地辨識報告的內容和相關性，以及支援中文和英文的查詢。我還需要與其他部門溝通需求和反饋，並且帶領我的團隊完成開發和測試。

Action: 我首先研究了市場上現有的資料搜尋引擎，發現它們都有一些缺陷，比如無法處理多語言、無法理解報告的語義和情感、無法自動分類和標籤等。於是我決定利用ChatGPT這個新興的自然語言處理技術來改善這些問題。ChatGPT是一個基於深度學習的模型，能夠生成自然而流暢的文本，並且能夠理解文本的意圖和情感。我利用ChatGPT來分析報告的內容和相關性，並且生成適合的標籤和摘要。我還利用ChatGPT來建立一個中英文互譯的功能，讓顧問能夠用自己熟悉的語言來查詢。我與我的團隊分工合作，開發了前端查詢介面和後端運行API，並且定期與其他部門開會探詢需求和收集反饋。我還負責監督測試和上線的過程，確保沒有任何錯誤或漏洞。

Result: 這個資料搜尋引擎成功地上線了，並且得到了顧問們的一致好評。它不僅減少了助理和策
