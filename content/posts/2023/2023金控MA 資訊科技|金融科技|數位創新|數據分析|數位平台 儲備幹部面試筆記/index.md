---
title: "2023金控MA 資訊科技|金融科技|數位創新|數據分析|數位平台 儲備幹部面試筆記"
date: 2023-01-11 00:53:00 +0800
lastmod: 2024-01-11T02:25:00+08:00
draft: false
author: "Hsiang"
...
*就準備自己履歷背景 其他就是看老闆問什麼達什麼*

*人格特質和氣場比較重要*

> *［三面總經理關 4 vs 4］金控總經理、金控資深協理、金控協理（前一關那 2 位）、金控人資長[^心得分享富邦/國泰/不能縮/台新/永豐]*
> - 自我介紹（3 分鐘）[自我推薦](#自我推薦)
> - 志願序排序理由 **(問動機)**
> - 分享一個專案 **(落地價值)**
> - 問問題
> 
> 這關主管提問的內容偏向實務應用，會想了解你專案的**落地價值**，然後挑戰你的論點（其實只有我被挑戰，其他人沒有）。
>
> *［三面大二董關 1 vs 4］大董、二董、 **(人壽)** 總經理、經理[^心得分享富邦/國泰/不能縮/台新/永豐]*
> - 自我介紹（不限時）
> - 簡報內容口頭敘述
> - 為什麼去投別家 MA（人資在總經理關的時候會問你目前其他家的進度）
> - 為什麼在當研究助理
> - 東吳財精在學什麼
> 
> 大董二董會很嚴肅地看著你，讓你備感壓力，但我就是一直對他笑，後來可能也被我的笑容感染了，氣氛比較和緩。這關回答問題要講重點，不需要太多鋪成，不講重點可會被打斷（別人說的）。總之高層都喜歡聽專案的**創新性**跟**可行性**，回答的時候要讓他們理解並且相信你，所以舉例很重要，越接近公司的應用場景越好。
>
> *三對四（人壽總經理、兩位副總、人資長，共30分鐘）[^多家金融機構]*
> 1. 自我介紹  
> 2. 進來之後想做什麼？  
> 3. 在物聯網經驗中，做過跟金融相關的專案？（我做過跟物聯網有關的實習  
> 4. 社團經驗？
>
> *四對三（人壽總經理、兩位副總、人資長，30分鐘）[^多家金融機構]*
> 1. 自我介紹(沒有特別限制時間)  
> 2. 富邦人壽為什麼要用你?  
> 3. 你對金融科技的甚麼類別有興趣
>
> *銀行總經理關 基本上是總經理一個人一對七（剩下的面試官都沒有講話）[^2019MA（中信富邦國泰玉山凱基台新南山)]*
> 1. 在面試過程中有沒有可以進步或想改進的？
> 
>     （總經理對大家的回答都很不滿意，表示一個筆記都不想記）
> 2. 告訴我你們為什麼要被錄取？很會泡咖啡？不要薪水？還是怎樣？
>   
...
- 2-3分鐘簡要說明自己學經歷，怎麼(為什麼)申請這個組
  ...
  **<mark>自我介紹要練好練順...</mark>**
- 資訊處長: 在IT的專案管理非常重要，在過往的經驗各位認為專案管理成功的關鍵原因是什麼?
  - 要有PO 有人負責才會有人監控績效
  - 分工 運行有效率
  - 測試 才能穩定 waterfall to scrum

  負責、分工、部屬與測試 才能面對消費者需求改善
- 金控總經理接著問: <mark>你對IT有興趣為什麼研究所還是選擇念財管</mark>

  在念研究所才發覺自己對資訊的興趣...(回答太短，忘記補工研院那段)  
- 金控總經理: <mark>到目前這樣的工作你沒有想要回財管的領域發展?</mark>
  
  希望累積硬技術結合財管知識...(回答得奇差)
- 說明過去與申請組別(金融科技/資訊科技)相關的工作或實習經驗

  (針對另一位應徵者提的敏捷開發，再問導入後改善了多少效率?)

  Quotation System -> 價格發現、解放人員，改善效率24hr...
#### 金控高階主管面談
> *［三面大二董關 1 vs 4］大董、二董、 **(人壽)** 總經理、經理[^心得分享富邦/國泰/不能縮/台新/永豐]*
> - 自我介紹（不限時）
> - 簡報內容口頭敘述
...
> - 東吳財精在學什麼
> 
> 大董二董會很嚴肅地看著你，讓你備感壓力，但我就是一直對他笑，後來可能也被我的笑容感染了，氣氛比較和緩。這關回答問題要講重點，不需要太多鋪成，不講重點可會被打斷（別人說的）。<mark>總之高層都喜歡聽專案的<u>創新性</u>跟<u>可行性</u>，回答的時候要讓他們理解並且相信你，所以舉例很重要，越接近公司的應用場景越好</mark>。
>
> ［結果］我用笑容感動了大家，喜收 offer
---
> *■四面：一對四（大董、二董、人壽總經理、金控人資長，10分鐘）[^多家金融機構]*
> 1. 現有的 Offer 選擇？ 
> 2. 介紹一下論文在做什麼？
> 3. 為什麼選擇捷克交換？
> 4. 未來想做什麼？
...
> Offer get
---
> *■四面：大董+銀行董事長+金控人資長/一個面試者10分鐘左右[^多家金融機構]*
> 
> 最後好像是10個左右正取，然後有備取，所以我覺得這關沒有刷很多人(但還是有機會!!)
> 
> 過程滿和平的，<mark>主要問經歷或是offer選擇</mark>，不太會問跟公司未來發展策略相關的問題。而論文題好像每個人都有被問到，十分鐘真的超短感覺才正開始的時候就結束了。
> 1. 看你的實習經歷，為何沒投國泰  
> 2. 中信和富邦都上了你會選哪家(前兩題是根據三面時人資的調查)  
> 3. 你想去中國外派為何不直接在當地找工作  
> 4. 說說你的論文
> 
> **■結果：**
> 
...
> **■心得：**
> 
> 富邦的三面大概是今年所有面試中最讓我震驚的一關，只要不夠謹慎隨時可能被挑戰，因此在回答之前都要斟酌再斟酌，也是我唯一搶答時不想搶第一回答的面試。
> 但是不得不稱讚富邦真的很有效率，三四面都是當天面完當天公布， 不用擔心太久。
> 
> 然後提醒大家，富邦四次面試都在不同的地方!!! 信件內容一定要看清楚啊!!!
> 我就是因為沒看到又太晚發現，導致富邦二面撞了國泰的面試又不能改時間了，悲劇。
---
> *第四關 大董關跟外資商銀教父二對一（旁邊的人資沒有說話）[^2019MA（中信富邦國泰玉山凱基台新南山)]*
> 1. 聊聊你自己（大董）
> 2. 論文在幹嘛（商銀教父：這很簡單啊）
> 3. 聊聊自己過去實習的那家銀行在中國大陸有什麼優勢（商銀教父）
> 
> 五分鐘就結束了也完全不苟言笑
> 
> 這場真的超級緊張，當所有最崇拜、而且只能在電視上看到的人出現在那裡，真的很害怕
---
> *■四面：董事長面試 (大董、二董、金控總經理、人資長 對 一面試者) 約5分鐘[^2019MA面試心得]*
> 
> 大董:介紹你自己
> 
> 介紹完問我交換的學校是不是跟我台灣的學校有合作，我說有合作
> 
> 二董:為什麼二面簡報選這個題目?簡報的重點與結論?
> 
> 大約講了一下，由於我的結論其實就是一般市場的看法，大董就開始發表自己的看法。然後
> 
> 結果：錄取
---
> ***第五關：Final面（大二董關）[^2021年MA面試錄取分享]***
> 
> - 面試官：大董、二董、總經理、人資長
> 
> - 面試者：一位
...
> - 時間：約10分鐘
> 
> - 內容：針對履歷、學歷背景、實習經驗和論文做敘述。

{{< admonition type=note title="富邦人壽-金融科技組-1111分享" open=false >}}
> -   **[4階面試] 金控董事長面談[^13家台灣各金控MA計畫完整面試分享]**
> 
> 先和之後要面這一關的面試者講，因為金控董事長真的很忙，所以如果接到面試通知是早上11:00~12:00，記得把下午時間都排開，因為面試時間可能會因為董事長會議Delay而延到下午。我覺得面到這一關，能見到董事長，不論有沒有上都值得了。共有6位Cadidates輪流和董事長、副董事長、和人壽總經理面試。每個人都只有大約6分鐘的面試時間，會先針對個人履歷詢問，建議要將自己要講的每一個經驗可能被問的問題都想清楚，才能在時間內做最好的發揮。個人履歷之外，都是問非常專業的問題。像是我被問到對於外溢保單的看法、甚麼是好的保險科技等等，提醒應試者要多針對最新趨勢做好準備。

- 外溢保單是什麼意思？

  ![外溢保單｜促進健康效果由事後理賠，走向事前預防｜南山人壽](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnKqV4YbfXf8AIeMj5lzTpRaqiJikibXQZkHk5qgm4rw&s)

  何謂**外溢保單**？  **外溢保單是**透過保戶<mark>自主健康管理</mark>與保險商品之結合由保險公司提供<mark>保費折減</mark>、<mark>增加保額</mark>或<mark>回饋金</mark>等服務鼓勵被保險人**規律運動、接觸健康飲食進而降低罹病率以達到事前預防之效益，同時減少醫療成本**，創造三贏**外溢**效果。
- 甚麼是好的保險科技
  + 好的保險科技是能夠提供更好的保險產品和服務，同時降低成本、提高效率和加強風險管理的技術。以下是幾個好的保險科技的例子：
    1. 數字化保險產品：利用數字化技術，將傳統保險產品轉化為更靈活、更可定制的產品，如Usage-based Insurance（根據使用情況計費的保險）、On-demand Insurance（按需保險）和Peer-to-Peer Insurance（點對點保險）。
    2. 人工智能和機器學習：通過對海量數據的分析，人工智能和機器學習可以幫助保險公司更準確地評估風險，提高精確度和效率。例如，人工智能可以自動化索賠處理，提高處理速度和準確度。
    3. 區塊鏈：區塊鏈技術可以幫助保險公司更好地管理數據和風險。通過區塊鏈技術，保險公司可以實現透明和可追溯的索賠流程，減少欺詐行為。
    4. 物聯網：物聯網技術可以讓保險公司更好地了解客戶的行為和風險，從而為客戶提供更好的保險產品和服務。例如，車輛保險可以利用車輛傳感器的數據來評估風險和計費。
    5. 虛擬和增強現實：虛擬和增強現實技術可以幫助保險公司更好地展示保險產品和風險，提高客戶體驗和理解度。例如，客戶可以使用虛擬現實技術來了解房屋保險的風險和覆蓋範圍。 
  + 保險科技是指利用科技手段來提升保險業務的效率和品質的一種創新模式。保險科技可以幫助保險公司提供更優質的服務，降低成本，增加收入，擴大市場，提高客戶滿意度和忠誠度。保險科技的應用範圍很廣泛，包括人工智能，大數據，區塊鏈，雲計算，物聯網等。保險科技的好處有以下幾點：
    - 提高保險流程的自動化和數字化，減少人工錯誤和時間成本。
    - 利用數據分析和預測模型，提供更精準的風險評估和定價，減少道德風險和欺詐行為。
    - 創造更多的客戶觸點和互動方式，提供更個性化和靈活的保險產品和服務。
    - 增強保險公司的創新能力和競爭力，應對市場變化和客戶需求。
...
3. 各國政府對 ICO 的監管狀況不同，部分國家開放監管，部分國家則限制或禁止。
...
- 50 m by 2025 with digital products solutions 

(Prudential)
##### 面試
看起來總共面三天，今天是策略經營組4人與資訊科技組3人

全程中文，只有兩個case study文章是英文，但可以用中文製作與報告

資訊的面試者一人還在碩二清大（水利工程相關論文跟ai有關的香港人）一人英國碩士一年多歸國念金融科技，會一些DS，主力是blockchain

###### 團體面試
上午**團體面試**（3-4位人資與1位策略長1位數位科技長）

分別跟面試官報上學校與姓名後

40分鐘case study形式不拘（40分鐘準備10分鐘報告）

這邊出現一個狀況，一拿到paper大家就開始各自讀paper做筆記
![保誠Prudential團面case個人結構.PNG](保誠Prudential團面case個人結構.PNG "保誠Prudential團面case個人結構")
大概過了15分鐘，策略長（新加玻人）看不下去笑說：這是團體報告，你們都各讀各的，待會怎麼搞

大家開始站起來，我問大家要不要聚集到中間，讓中間同學幫忙做簡報（因為早上報到時看到他疑似在看什麼簡報，感覺他很會做ＸＤ）接著大家開始討論

我提出剛剛讀報告想的結構跟邏輯，並在過程反覆確認，確認我們有在對的方向，並主動提出想法讓大家可以集思廣益，並在過程確保大家的發言都有被考慮到

製作簡報的同學也會反覆跟我們確認內容，另一位女同學也會主動提出想法，大家一起討論

時間快到時我提出該分配誰報告哪了，這兩位分別選了背景跟流程的部分，我則負責提出各種通路推廣改善與解決方案
![保誠Prudential團面case團隊結構.PNG](保誠Prudential團面case團隊結構.PNG "保誠Prudential團面case團隊結構")
接著報告後根據內容進行ＱＡ

首先是讓沒有報告的同學發言提出觀察與看法

中間都是圍繞簡報內容提問，例如：…

最後是覺得這次case study裡自己哪裡做得好？如果重來哪些地方可以改善？*(後來想想其實應該也可以加上對組員的評論點出每個人的優點，更全面)*

> 上午場的團體case study人資會全程觀察點有可能在報告結束後針對個人提出疑問，例如說誒我看你在討論的時候有提出一個論點...
> 
> 午休跟另一位資訊組的同學聊得不可開交（blockchain真有趣）
###### 個人面試
下午**個人面試**（一人資一數位科技長）

*(40分鐘製作簡報5-7分鐘報告) 不過其實我沒太算時間，反正就是做什麼講什麼*

前面做簡報就不順，因為沒有延長線（讓給另一位女同學），電腦又一定要充電，花了五分鐘在搞，最後是站著在插座附近邊讀邊做ＸＤ

內容主要就是你是一位數位轉型長，根據內容提出你的行動，為什麼，prioritizing跟預期結果，內容比早上的更多，時間要好好掌控，建議一開始就邊做ＰＰＴ邊讀
![保誠Prudential個人面case結構.PNG](保誠Prudential個人面case結構.PNG "保誠Prudential個人面case結構")
製作沒有模板，整體幾乎就是黑白與條列ＸＤ

後來沒做完，硬著頭皮去報告，還好雖然ppt沒做完，但報告有大概讀完，心裡有大概的架構跟邏輯，所以雖然後面幾頁沒有ＰＰＴ，但還是能大概口述完畢
...
- 你怎麼確定提升參加率能夠提升營收等
  ...
  （簡單好用、穩定）		
- （怎麼改變ＩＴ思維）所以你會從人開始著手對嗎 (Incentive)

然後是關於面試者的提問
  - 你大學是念資管嗎？怎麼學這些技能的，都是自學嗎？
  - 為什麼想來保誠
  - 分享一個失敗的案例
  - 分享一個合作的案例
  - chatgpt的應用案例，機敏資料怎麼辦？我們不太可能自己訓練怎麼辦？

我的提問有
1. 網路上找不太到保誠ＭＡ的相關資訊，可以說明一下如果加入後的工作狀況具體來說會是怎樣麼？

    ＩＴ分核心與數位資訊，核心比較跟產品週期有關（保險動輒數十年，怎麼整合老資訊老系統），數位資訊算新成立，會跟data有關
2. follow up數資長的回答再問： 所以各國ＩＴ有機會聚在一起討論方向，如果很優秀還能夠提出方案，甚至有機會全球apply

> 結束後才想到可以多詢問: 之前有資訊科技的MA嗎？他們有參與的什麼專案？*(四屆而已)*
>
> 面試過程很放鬆，數位科技長跟人資都很親切，不小心面超時10分鐘ＸＤ
>
> **發現這幾次面試，長官都有一些特點，幫忙翻譯面試者回答，用精簡的語言並確認是否為真**
#### 最終面試
與高階主管的實體面試
...
> 資訊科技：負責**數據分析**以幫助通路團隊深入**了解客戶**、規劃執行各項**策略性數位專案**以及**新科技的整合運用及導入**，提供更**優化的數位客戶經驗**。
...
l **面試地點**：台北市信義區松智路一號8樓 ( [http://goo.gl/EYJEbs](http://goo.gl/EYJEbs "http://goo.gl/eyjebs") 位於松高路松智路交叉口，信義誠品對面的花旗大樓，大門入口在松智路上)

到達後需於一樓管理櫃檯換證件方可上樓，請記得攜帶身分證件；到達8樓，可使用入口處話機直撥1627與林先生聯絡。

預祝您面試順利！

rundown:
- 一對一(or多)個人背景問題 職涯方向問題 60分鐘
...
- 說明工作中某個專案，擔任角色以及專案流程(**你對專案的貢獻&專案對公司的貢獻**)
- 簡單對話檢驗英文能力
- 與人溝通互動經驗分享
- 組內衝突解決經驗(你有沒有面對conflict的情況，對組員、對主管或老闆)
- 如何設定事情先後順序
- 動機，對公司、組織，以及工作內容的了解
...
-   So that we can leverage on each other’s knowledge
    

What do you think of the interview experience last time

-   Interesting
    
-   Remember those mistakes I made
    
-   To test our innate team player style
...
#### 第二階段專題簡報
**收到三組簡報邀請: 零售金融、法人金融、資訊科技**

選擇**資訊科技**組，放棄另外兩組

選擇題目: 在2023年的ChatGPT應用熱潮下,請探討金融業整合此類生成式 AI 模型的優點和缺點,並規劃㇐項最佳應用。

二、面談內容

**1、** **專題簡報：報告時間每人****5****分鐘，中英文不限，不含自我介紹**

**2、** **團體面談：事業單位處級主管面談**

三、面談時間：**60分鐘**

四、其他：請穿著正式服裝；另，考量各位面試者的衛生安全，全程仍須配合防疫措施並配戴口罩

**在2023年的ChatGPT應用熱潮下,請探討金融業整合此類生成式 AI 模型的優點和缺點,並規劃㇐項最佳應用。**
> [#不專業分享文 面試-永豐銀行 儲備幹部MA - 工作板 | Dcard](https://www.dcard.tw/f/job/p/236252443)
>
> 事業單位高階主管面談(30 mins)
> 
> 一場5位面試官，1-3人面試者，5位面試官會一個一個針對他想要問的人做提問。
> 
> 我被問到的問題是
> 
> - 自我介紹，簡單講研究助理工作內容。
...
> - 進來零售管理處，你想做什麼？
> - **分享數位金融體驗和你覺得哪邊可以改進**。
> - **對於銀行來說，區塊鏈最大的隱憂以及你進來銀行單位話怎麼改變應對這件事情**。
> - 我的想法是不是會取代徵信機構的功能？
> 
> 這階段，我認為他們想要知道你是**否了解應徵單位**和考驗你的簡報能力(**製作簡報**和**講述報告**)。
> 
> 建議：
> - 簡報時間5分鐘以內，不可超時，<mark>在家多練習</mark>。
...
> •  二面（簡報關，因疫情改線上）約20分鐘
> 
> 這一階段的面試有約4天的時間製作簡報（不管選幾個題目總共就是4天），因此時間的安排很重要，因為可能同時也要製作其他公司的簡報。
> 
> 1. 數金組：對純網銀的看法? 給一般銀行帶來的影響?（自選）
> 2. 營管組：如何使用會員、訂閱經濟帶來獲客流? （自選）
> 
> ⋄ 簡報製作邏輯供參考：自我介紹（三大亮點）→台灣市場**痛點描述**→**解決方案發想延伸**→**商業模式**&**預期效益→未來發展**。以上只是一個模板，須依照題目變通。
> 
> ⋄ QA相關：
> 
> 1. 問自我介紹、跟工作的連結
...
3. QA、對單位的了解
##### 面試
![永豐銀第二階段專題簡報面試現場筆記1.jpg](永豐銀第二階段專題簡報面試現場筆記1.jpg "永豐銀第二階段專題簡報面試現場筆記1.jpg")
![永豐銀第二階段專題簡報面試現場筆記2.jpg](永豐銀第二階段專題簡報面試現場筆記2.jpg "永豐銀第二階段專題簡報面試現場筆記2.jpg")
#### 第三階段面試
**最終階段<永豐策略人才>2023永豐銀MA培訓計畫-決策主管面談**

*組別志願序：https://www.surveycake.com/s/8Q4qK請於2023年5月3日中午前完成。*

流程內容  (整體流程約60分鐘)

**1、** **自我介紹：每人****1****分鐘，中英文不限，附件****個人推薦表****(PPT)****，請於5/3(一)中午前繳交，逾期視同放棄。如有錄取兩個組別，也僅須提供一份推薦表(檔名請註明：學校系所/姓名，eg.永豐大學銀行所/王永豐)****。PPT格式請勿任意修改**

**2、** **情境活動：題目為跨組別跨領域，到場後直接抽取，每人30分鐘準備，並須於1分鐘內向決策主管報告**

**3、** **團體面談：每場****5****位人員同時與<mark>總經理及各處決策主管</mark>面談**

**4、** 其他：請務必穿著正式服裝；另，考量各位面試者的衛生安全，全程仍須配合防疫措施並配戴口罩

*個人推薦表(PPT)，請於5/3(一)中午前繳交:* 勿超過一頁，以*300字*為限，需包含<mark>自我介紹</mark>、<mark>申請動機</mark>、<mark>社團或實習經驗</mark>等

高階主管想看，突出經歷、談吐、邏輯、穩定度、氣場
##### 自我推薦
> 資訊科技組
>
> 數位金融專案規劃與產品創新、大數據資料庫行銷分析與應用、AI人工智慧應用研發及machine learning模型建置，以有效驅動整體數位、資訊發展，提供科技賦能、行動永豐之使命。
1. 比別人好的地方: (學歷專業)、經歷、學習能力
2. 能為BU及單位帶來的貢獻: Data, Infra, PM 三者兼備
3. 動機

<div hidden>

*在香港最大資產管理公司(前EAM現MFO)擔任IT Manager，在加入初期發現原有結構型產品詢價流程冗長且人工，外包系統費用昂貴，功能被限制且還要被抽手續費，遂開發了自己的系統，並額外加入客戶管理、自動風險監測、多家銀行合併月結單等功能，取代原有的人工與外包白標應用，替公司省下1年超過180萬新台幣支出，功能上雲且大幅提升顧問使用率與減少內部助理負擔...*
{{< admonition type=note title="desc1" open=false >}}
這個人的自傳提到了他在香港最大的EAM/Family Office擔任IT manager，負責開發前後端、資料庫建置、管理內外部Apps，以及為BU提供RPA方案並交付，成功開發了新的交易及管理程式，取代舊有外包的white label app，節省了公司1年180萬新台幣的支出，並獲得了中國一線券商的洽詢對接。除此之外，他也為公司其他部門進行了數位化、RPA優化，使得各部門更能將時間投入在增進其核心功能上。他認為自己對於金融產品、市場，以及科技都有著相當的理解和經驗，希望在儲備幹部計劃中能夠加深學習並發展自己。他對於金融科技特別有興趣，期望在數位金融產品開發、數據分析、數位平台、人工智能等領域中有所成就。此外，他曾經開發了響應式跨裝置網頁台灣清冠一號地圖，以便讓染疫或未染疫但有視訊看診或清冠一號處方需求者能夠透過互動式地圖實時查閱所在地周遭資訊。
{{< /admonition >}}
{{< admonition type=note title="desc2" open=true >}}
目前在香港最大的EAM/Family Office擔任IT manager，負責資料庫、前後端開發、App管理、RPA方案等工作。我擁有中山財管MBA學位，並在Kaggle上獲得四項專家成就，是一位具備金融與科技雙重專業的人才。

我對於數據分析、資料科學、機器學習等領域有深厚的興趣與實務經驗，曾參與多項競賽與專案，並取得優異的成績。例如，在Shopee - Price Match Guarantee競賽中，我使用EfficientNet模型來對商品圖片、名稱進行分類，並與來自不同國家的隊友合作，最終獲得前4%金牌殊榮。另外，在工研院AI與深度學習專案中，我擔任組長，使用YOLOv4, YOLOv5 和 MobileNetv2 建立亞洲交通物件偵測模型，並應用於嵌入式裝置，提升了20% mAP與降低了模型計算負擔。

除了數據分析與機器學習外，我也具備資料庫、前後端開發、App管理、RPA方案等能力，能夠開發出符合使用者需求的應用程式。例如，在香港EAM/Family Office中，我開發出新交易及管理程式，取代舊有外包的white label app，替公司節省了1年180萬新台幣支出，並加入了多項產業領先應用。此外，我也為公司其他部門進行了數位化、RPA優化，節省人力、提高工作效率。

我想加入永豐銀資訊科技MA的原因是，我認為在現代金融產業中，數位轉型和創新是必要的。而永豐銀資訊科技MA的計劃目標與我的專業知識、工作經驗、興趣相符，是一個很好的學習與發展的機會。我希望能夠將我的數據分析、資料科學、機器學習等能力，以及資料庫、前後端開發、App管理、RPA方案等技術，應用在永豐銀行的各項業務和服務上，創造更大的價值。我也期許自己能夠在持續變動的環境中快速學習，不斷成長。我相信自己能夠成為一位Data, Infra, PM 三者兼備的優秀人才，為永豐銀行的數位轉型和發展做出貢獻。
{{< /admonition >}}
...
在mongodb 跟 postgresql的差異，以及兩者未來(在金融業)的發展答歪了...GG

***(本來應該是可以加分的地方)***
##### 事後回想與回答驗證
- mongodb 跟 postgresql的差異，兩者未來的發展

  MongoDB 和 PostgreSQL 是兩種不同的資料庫系統，各有其特點和用途。以下是兩者的主要差異：

  1.  資料結構：**MongoDB 是一個非關聯型資料庫**，使用的是文件（document）存儲方式，類似 JSON 格式。**PostgreSQL 是一個關聯型資料庫**，使用的是表格（table）存儲方式。
  2.  資料庫架構：MongoDB 是分佈式資料庫，支援自動分片和複寫，可以實現高可用性和橫向擴展。PostgreSQL 是單機資料庫，可以在單個伺服器上運行，也可以實現主從複寫和流式複寫。
  3.  查詢語言：MongoDB 使用的是基於對象的查詢語言，稱為 MongoDB 查詢語言（MQL）。PostgreSQL 使用的是結構化查詢語言（SQL）。
  4.  適用場景：**MongoDB 適用於需要處理大量非結構化數據的場景**，如網站日誌、社交媒體數據等。PostgreSQL 適用於需要處理關聯型數據的場景，如企業系統、金融系統等。
      
  在未來的發展方面，MongoDB 和 PostgreSQL 都將繼續進行技術創新和功能升級，以滿足不斷變化的市場需求和用戶需求。具體來說，MongoDB 將繼續發展分佈式數據庫和大數據技術，以及更好地支援雲端運算和人工智慧等新興技術。PostgreSQL 將繼續發展高可用性和擴展性，以及更好地支援 JSON 和全文搜索等新特性。總體而言，MongoDB 和 PostgreSQL 都將繼續努力提高自己的性能、穩定性和易用性，以滿足廣大用戶的需求。
- 哪一個比較輕量

  就資料庫系統的輕量程度而言，MongoDB 和 PostgreSQL 都可以視為相對輕量級的資料庫系統，因為它們都可以在一般的伺服器上運行，並且具有高效的性能和低資源消耗。但是，它們的輕量級程度取決於使用情況和資料庫設置。

  通常情況下，**MongoDB 在處理非結構化數據時比較輕量級**，因為它使用的是文件存儲方式，可以快速查詢和修改單個文件。而在處理結構化數據時，PostgreSQL 比較輕量級，因為它使用的是表格存儲方式，可以更有效地處理關聯型數據。

  然而，需要注意的是，MongoDB 和 PostgreSQL 都有其各自的優點和缺點，在選擇使用哪一個資料庫系統時，應該根據具體的應用場景和需求進行評估。
- 哪一個比較多人用比較熱門

  就全球使用量和知名度而言，目前 PostgreSQL 比 MongoDB 更加熱門和廣泛使用。這是因為 PostgreSQL 是一個傳統的關聯型資料庫系統，在企業和商業領域中應用較廣泛，被認為是更加穩定、可靠和成熟的資料庫系統之一。
...
> 您好，
> 
> 不好意思昨天下午在開會漏讀email跟電話。
> 
> 感謝您對我的應徵表示興趣，並安排視訊面試的時間。我很感激您花時間與我交流，讓我更深入地了解您的公司以及工作職責。
> 
> 由於最近的情況發生了一些變化，我不得不重新考慮我的應聘計劃。很抱歉地通知您，接下來可能無法報到。
> 
> 再次表達我的歉意，讓您花費寶貴的時間安排了這些面試。我真心感謝您給我的機會，希望未來有機會能夠再次與您合作。
> 
> 祝您的公司持續發展，希望您的招聘順利進行。
</div>
...
**Note: 雖然有簽NDA，不過面試經驗已於面試時與人資確認過，在招募流程結束後可分享**
...
料想會像永豐一面那樣不同組別主管一起+人資 or 全人資 -> **這關要準備情境型與履歷方面問題**

從元大得到的建議: **要更深入研究目標公司產品**
##### 銀行-科技儲備幹部
科技團隊以打造數位銀行能力為核心，實現國際化經營能力為願景，透過「打造創新研發環境」、「推動資訊架構現代化」、「發展新型態金融商品和創新服務」，並以客戶體驗為中心價值實踐科技金融新生活。

加入科技儲備幹部，您將與來自金融業、科技業、新創及各行業神人夥伴協作與共事，參與「**人工智慧技術、區塊鏈、雲端科技、場景實驗與客戶使用驗證、資訊架構及資安治理改革**」等新穎專案，一同創新並驅動變革。第一年的培訓中，將為您奠定全方位業務知識基礎，第二年實務應用歷練深耕深化專才訓練，拓展視野與提升專業企劃力，並可獲得與國內外Fintech業者及國際頂尖科技顧問公司交流協作、參與高階管理層會議等難得經驗，快速積累專業知識、掌握業務全貌。

【MA的日常】
-   面對全球金融科技日新月異的發展，新型態金融服務為金融業核心競爭策略。成為科技MA將擁有多元機會，參與企業層級的各類數位、資訊及資安專案，且有機會接觸來自跨界的科技好手、知名國際顧問及Fintech新興之秀，並與台灣金融頂尖團隊、神人菁英共同成長，你/妳將成為「金融 X 科技」的強者。除了輪調學習外，科技MA能透過：
-   持續關注國際金融科技應用、金融監理趨勢，並<mark>研討落地應用可行性</mark>，逐步**提升管理視野及企劃能力**。
-   投入熱愛之新科技學習，充實客戶洞察、創新技術與數位行銷的專業知識，**致力創新商品、落地商轉**。

【誰適合】
-   樂於面對挑戰，不斷尋求業務有效開展及風險適法平衡之最佳解答。
-   熱愛科技、對未來充滿想像，轉化創新想法並具體實現。
-   具資工、資管、理工、統計、商學等多元背景，或對軟體工程、人工智慧有興趣之跨界菁英。
##### 銀行-個人金融儲備幹部
中信個人金融團隊跨足數位金融應用、新興支付實務、海外分行營運、頂尖財富管理、消費金融服務等業務。選擇個人金融儲備幹部，除了有量身打造的金融專業學程外，藉由兩年完整的輪調計畫、同時參與跨部門合作專案，培養邏輯思考與策略規劃能力，快速累積不同產品及客群行銷的實務經驗，淬鍊為兼具金融知識及實務歷練的專業經理人。

中信個人金融團隊是臺灣財富管理、消費金融與支付金融的先驅，以設計思考、大數據分析等方法洞悉不同客群的需求，並結合智能演算及敏捷開發，推出了「Home Bank」APP、智動GO智能理財、對話式ATM等多元創新的數位金融服務。此外進一步結合外部場景，與各產業龍頭合作推出多元支付工具，共同建構產業生態圈，使金融服務融入於日常生活行為中，滿足廣大客戶及用戶的金融需求。我們將漫天飛舞的創意付諸行動、落地執行，並深耕於用戶的生活圈。讓我們在數位應用、金融產品及客群行銷上，走在金融科技的最前端，引領台灣金融新浪潮！

【MA的日常】
-   個人金融團隊與Fintech緊密相連，除了多元的培訓課程外，更有機會實地參與多樣化的數位專案，如數位帳存、臉部辨識、指靜脈、AI語音技術，甚至可以參與產品廣告提案、異業賽事舉辦等豐富的活動，個人金融MA是具備創意又靈活多變的代表！
-   除了輪調外，MA能透過專屬Mentor制度與高階長官定期討論業務與邏輯方法，從無到有堆疊出邏輯架構緊密且資料連貫的報告，對日後業務執行、異業合作提案，是最有助益的實力養成方式。

【誰適合】
-   擁有漫天飛舞的多元創意，並願意將想法付諸行動，落地執行
-   積極熱忱、具高抗壓性且樂於享受挑戰
-   學經歷及科系背景不拘
##### 台壽-保險數位儲備幹部
台壽保險數位團隊以客戶為中心，橫向串聯前中後台的營運單位，創造客戶體驗最佳的保險旅程。 保險數位儲備幹部在輪調期間，不僅會參與重要策略性專案，例如TeamWalk職場健康管理、智能客服專案等，也能透過學習優化流程的方法論，以做中學的方式累積數位產品開發經驗。台壽保險數位團隊負責數位平台開發、維運與數位行銷，我們透過線上預約顧問服務與網路投保，掌握客戶的需求，提供客製化的商品與服務，並透過LINE及保戶網站，放便客戶即時查詢保單資訊。

看準社群行銷與生態圈發展趨勢，我們也藉由與網紅、異業合作並搭配數位廣告投放策略，讓客戶了解提供的數位服務。此外，我們導入NPS與VOC機制，藉由聆聽客戶聲音，確保並修正服務規劃以滿足客戶需求。

【MA的日常】
-   保險數位MA能在金控、銀行及人壽數位部門輪調，擁有多元機會參與各式數位專案的規劃與執行，了解數位金融策略、新科技導入、數據分析、網路及行動銀行業務營運與客群經營模式，將可培養客戶分析模式、客群分類邏輯及資料分析技術，並透過參與最新Insurtech潮流和紮實的專案，養成保險數位轉型規劃能力。

【誰適合】
-   個性主動積極、熱愛學習新事物
-   對未來創新的科技應用充滿想像，並對數位行銷、客戶體驗具有熱忱
-   商管、金融、理工、科技、資訊或其他跨界人才
##### 準備
>[2022&2021 金融業MA 面試題目/心得分享 富邦/國泰/不能縮/台新/永豐 - 金融板 | Dcard](https://www.dcard.tw/f/financial/p/238852201)
>
>［一面人資關 + 筆試 2 vs 2］2 位 HR
>
>- 自我介紹（沒限時）
>- 說說本司在金融科技做了什麼，你可以為這些帶來什麼幫助
>- 志願問題
>- 投哪幾家MA
>- 你認為MA要有什麼特質跟能力，你有什麼
>- 你覺得你像哪個知名人物，為什麼
...
>筆試：語文測驗、數理測驗、圖形測驗
>
>語文大部分是同義反義詞。數理是小學數學。圖形是智力測驗。絕對寫不完（可能我廢？），難度中等。
>
>面試完會給一份問卷，主要是調查面試流程的流暢程度。除此之外，面試完後可以調整志願序。是希望經過 HR 的引導後，讓面試者找到更適合自己的志願。
>
>沒有輟啦，我家的人資真的很認真，第一關就問你超多問題。我本來以為空降可以隨便面面，沒什麼準備，結果超難的阿。你們要來的話不要隨便亂搞欸。
...
時事討論、個人履歷問題[^中國信託金融控股股份有限公司面試趣]
- 你的人生夢想是什麼[^中國信託金融控股股份有限公司面試趣]

多看時事並想像如果自己已經錄取會對這個新聞時事有什麼看法。例如烏俄戰爭、利息調升等議題。記得加入賴群MA裡面很多人分享相關面試經驗及進度。[^中國信託金融控股股份有限公司面試趣]
...
結果因為之前的短暫MA經驗，被不斷挑戰動機是否足夠，雙方資訊交換是否順利，瘋狂確認動機與對中信MA programme的了解，以及其需要技能的認識、對壓力或績效的定義等等，專業問題倒沒什麼。

感覺起來這關主要在測試來應徵的人員是否足夠忠誠足夠認真，這裡的認真指的是真心希望在中信MA Programme生存並久待的決心跟準備。
### 新光
#### 儲備幹部
數位個金組

【工作內容】  
成為新光人，探索你的無限可能 ★熱烈歡迎應屆畢業生／社會新鮮人★  
「儲備幹部(MA)培訓計劃」以培育銀行接班梯隊為目標，於兩年培訓期間，分為<法人金融組> 及 <數位個金組>進行招募與培訓，進行完整且紮實的教育訓練，並透過參與專案任務、經營活動及海外歷練等階段性培訓，成為獨當一面的經營管理人才。  
  
【新光MA計畫特色】  
★【理想成就】成為經營管理人才，培養具競爭力技能與策略性思考  
★【深度淬鍊】各部門輪調歷練，接觸各單位專案，拓展視野、快速成長  
★【豐富資源】與金控集團各子公司合作，多元培訓與學習，制度完善  
★【多元舞台】洞悉並掌握世界金融趨勢，第一線實戰參與，突破自我  
如您對金融產業具備高度興趣、對市場動向擁有敏銳直覺、對專案執行充滿創意與想法，新光給您最廣大的舞台，挑戰自我、開創新未來，一同邀請您加入新光MA計畫！  
...
期許自己能夠善用自己對於金融產品、市場，以及科技的理解及經驗，並在持續變動的環境中快速學習，讓每一次經手的專案或產品價值都能夠大於前次，不斷成長。另外，除了產業、產品，及技術等硬實力外，也要具備優秀且能獨當一面領導團隊共同進步的軟實力。其中我對金融科技特別有興趣，我希望能夠在儲備幹部計劃結束後進入相關公司部門工作，例如數位金融產品開發、數據分析、數位平台、人工智能等領域。相信自己能帶領專案，產出能商轉或是為公司帶來巨大利益的產品，為公司的數位轉型和發展做出貢獻。此外也希望自己能成為在這個領域的指標人物，樹立榜樣，為大家帶來正面影響。
...
- Jane Street Market Prediction，以TensorFlow建置simple NN - MLP利用 purged grouped time series CV驗證訓練效果提升模型成效。
...
2.面試地點：台北市信義區松仁路36號19樓

3.面談請著正式服裝應試，並依面試時間前10分鐘報到。

4.若要調整面試時間，請來信註明原因及可行的時間  ，以利後續安排，以免影響您的面試權益。

5.若遇颱風等天然災害、不可抗力因素，台北市政府宣佈停止上班，本行面談即依公告取消，並於恢續延期面談事宜。

6.甄選下一階段：合格者將收到「**AI****雲端智慧面試**」，〔複試〕預計五月中旬、〔終試〕預計六月C新光銀行感謝您的熱情參與！
...
> 感謝您對我的應徵表示興趣，並安排視訊面試的時間。我很感激您花時間與我交流，讓我更深入地了解您的公司以及工作職責。
> 
> 不過，由於最近的情況發生了一些變化，我不得不重新考慮我的應聘計劃。很抱歉地通知您，我可能無法繼續參加您公司的工作面試。
> 
> 再次表達我的歉意，讓您花費寶貴的時間安排了這次面試。我真心感謝您給我的機會，希望未來有機會能夠再次與您合作。
> 
> 祝您的公司持續發展，希望您的招聘順利進行。
### 遠銀
數位金融事業群
...
> 考量打聽到薪資好像只有5.5w一個月，面試前一天婉拒下一階段面試
...
> 1. 報到時間：**4/21下****午****13:30**，建議您可以提早上線測試視訊設備
> 
> 2. 面試時間：**4/21****下午14:00**，預計1小時，視當天面談實際情況彈性調整
> 
> 3. 面談主管：管理部人力資源處
> 
> 4. 面談方式：以中文、團體面談
...
> 5. 面談準備：
> 
> 	(1) 關於產業：能掌握金融證券產業趨勢與現況，並能提出見解與觀點
> 
> 	(2)
> 關於公司：熟悉統一證券業務、營運現況、未來展望、組織文化、定位與優勢等，可查詢統一證券官網、企業社會責任報告書、年報、新聞等相關資料
> 
> 	(3) 關於職務：根據以上兩者，掌握身為未來擔任所選組別之「主管」的角色與職責，並了解未來可能會遇到的管理情境
> 
> 6. 面談地點：使用CISCO  WEBEX MEETINGS視訊面談

去年的**資訊MA**月薪60k一年有1m 今年的**數據MA**卻沒寫，看起來可能只有50k一年0.8m，*加上也請太多假了*，遂在面試前幾天寄出婉謝信給人資。
...
*(後來不確定人資是沒收到信還是漏看或是忘記，面試當天上班時間又連打了好幾通電話過來，開完會才注意到)*
### 元大
#### 數位金融儲備幹部
...
##### 學長姐分享
- [元大金控2023 MA儲備幹部計畫人才招募 (yuanta.com)](https://hr.yuanta.com/ma/)
- [(20+) Watch | Facebook](https://www.facebook.com/watch/?v=1051727871874109)

{{< admonition type=note title="卓彥棋金控-數位金融事業處" open=false >}}
享受克服困難後的成長

元大MA是我的第一份工作，也很感謝元大願意投入這麼多的資源讓我這個社會新鮮人能享有非常扎實的培訓。在培訓期間，透過每一次的分組報告、組員間的腦力激盪還有最後主管給予的回饋，都能讓我意識到自己的不足並明白精進的方向，讓自己在每次的簡報後都能更**了解長官對於不同議題的思維**也讓自己有所成長。緊接而來的部門輪調見習，也讓我**對於各子公司的業務更加清楚**。整個過程讓我既能**培養問題分析與解決的能力**又能掌握**實務經驗**。

回到工作崗位後更有許多的專案需要透過上述的能力來去克服所有困難，參與元大MA計畫將讓你時刻充實自我，並結識優秀的夥伴，團隊合作解決問題。如果對金融業感興趣且樂於挑戰，這裡絕對是最適合你的地方！
{{< /admonition >}}
{{< admonition type=note title="黃柏竣金控-數位金融事業處" open=false >}}
正確的選擇是成功的一半！

從招募過程中就可以感受到元大對於人才培育的高度重視，扎實的培訓課程更是凸顯了對MA的器重，訓練期間各子公司的**高階長官將親自蒞臨指導**，幫助我們快速了解金融業的真實輪廓，學習<mark>高階經理人的思維與精神</mark>。此外，每周的專題報告考驗著我們**如何解決問題，並從中培養邏輯思維與表達能力**，長官們也會根據報告內容給出實際回饋，使我們能在改進中逐步成長。

元大提供最完整的培訓計畫，訓練MA擁有<mark>金控思維</mark>，讓我們能站在<mark>更高的視野思考</mark>，並**解決問題**。若你也是**喜歡思考**、**熱愛挑戰**的人，那元大MA計畫將是你最棒的選擇！
{{< /admonition >}}
{{< admonition type=note title="李學典金控-數位金融事業處" open=false >}}
在元大只有與自己的競爭，成就操之在己

元大訓練MA的方式有別於其他同業，在前兩個月會密集訓練，讓MA與各子公司的高層主管近距離互動，並透過扎實授課與經驗分享迅速**累積金融實務**，並將這些學習內化成自己的養分。同時從每週**主題性簡報內容產出**與展示，讓MA不斷探索並與同伴一同腦力激盪，高速培養即戰力。

集中訓練完後會讓MA實際見習各單位部門，從中找尋可以協助集團改善的問題點。整個探索的過程都可以直接跟高階主管進行討論，設身處地的為公司梳理業務問題，並在兼顧效益與遵法下，設法提出可行的解決方案，將自己的想法付諸實行。最後，把自己嘔心瀝血的提案報告給各董總與各部門的長官，展現自己的價值。
...
- (證券)元先生
  - 最近有什麼法說會或消息是我該注意的 <- 讀取positions，找出相關新聞(，以及當時熱門)
  - 根據我的風險偏好，什麼樣的標的比較適合我 <- 推薦系統(別人買，我還沒買的)

- 你欣賞的金融科技，元大可以借鏡的[^元大金控面試趣]

  <span class="fz-t3"><i>如果有準備過雅思或托福，應付英文測驗應該蠻容易的<br>
  可以事先準備幾個PPT報告、主題素材或研究圖表在手邊備著，對即席簡報製作有幫助～[^元大金控面試趣]</i></span>

- [元大金控-儲備幹部-面試經驗分享(一)面試經驗暨工作甘苦談-1111人力銀行](https://www.1111.com.tw/1000w/fanshome/discussTopic.asp?cat=fans&id=232038)
- [2019儲備幹部MA面試心得分享｜各金融機構超完整心得（上） – enJoy's (wordpress.com)](https://joysenjoy.wordpress.com/2019/06/27/2019%E9%87%91%E8%9E%8D%E6%A5%AD%E5%84%B2%E5%82%99%E5%B9%B9%E9%83%A8ma%E9%9D%A2%E8%A9%A6%E5%BF%83%E5%BE%97%E5%88%86%E4%BA%AB/)
- 你提的某個ｉｄｅａ很好，但要怎麼提案說服公司進行這樣的事情？
  - 提供案例或者數據
- 如何增加證券平台的黏著度？
  - 消費者體驗
- 最常用的數位金融服務？
...
- 對元大的了解？
- 對於元大金控哪邊能做得更好，有什麼想法？
- 為什麼選擇金融業？為什麼元大要選擇你？現今市場還有什麼痛點沒被解決？
- 金控、銀行、證卷，若有幸進來的話，你想要怎樣的順序
- 問一個問題？

- 邏輯測驗

  <span class="fz-t3"><i>一面地點:臺北的一間會議中心<br>
  形式:先對於元大MA計畫講解，後進行30分鐘邏輯測驗，<b>很難一定寫不完</b>，記得不要用猜的。測驗完後進行30分鐘簡報製作，隨後5分鐘上台報告，剩下的時間都是雙向交流。<br>
  薪資:65,000<br>
  時間花費:3小時[^元大金控面試趣]</i></span>

- 對於俄烏戰爭的看法

  *舉手搶答，記得踴躍一點舉手發言，但是一定要有邏輯，面試官會對於回答做challenge[^元大金控面試趣]*
...
![元大即席簡報評論2與筆記.png](元大即席簡報評論2與筆記.png "元大即席簡報評論2與筆記.png")
...
- 您認為證券業與一般金融業的異同為何？您具備那些專長或技能來迎接為期1年MA培訓與實作? (600字內)
  ...
  *問能帶來的價值*
  ...
  > 
  > 永豐金證券成熟完整的MA培訓制度，作為台灣證券創新龍頭，永豐金證券提供最新穎貼近消費者的金融服務，而MA的培訓制度又能讓人才在加入公司後藉由在各領域的學習，擴大自身技能廣度以及深度。配合培訓體系的完整規劃以及對業務養成的前瞻理念，讓訓練不只紮實且挑戰，提供最佳的成長空間。
  > 
  > 而這與我的能力及興趣不謀而合，結合我在中山財管MBA訓練的商管素質及知識，與目前在香港金融EAM龍頭擔任IT Manager練就的快速研究熟悉創新技術並開發實作的能力，在持續變動的環境中快速學習，為組織帶來。期許自己能擴充自己的影響力，讓每一次經手的專案或產品價值都能夠大於前次，不斷成長。另外，除了產業、產品，及技術等硬實力外，也要具備優秀且能獨當一面領導團隊共同進步的軟實力。
  > 
  > 相關作品:
  > -   Personal Website:  [https://hsiang.eu.org/](https://hsiang.eu.org/)
  > -   GitHub:  [https://github.com/chienhsiang-hung/](https://github.com/chienhsiang-hung/)
  ...
  證券業和一般金融業都屬於金融服務業，它們之間既有相似之處，也有不同之處。下面是它們的相同和相異點：

  相同點：
  1.  金融服務提供者：證券業和一般金融業都是提供金融服務的機構，其主要目的都是為客戶提供金融產品和服務，以滿足客戶的不同需求。
  2.  金融市場參與者：證券業和一般金融業都是金融市場的參與者，它們在金融市場中扮演著重要的角色，影響著市場的運作和發展。
  3.  資本市場中的一員：證券業和一般金融業都是資本市場中的一員，它們促進了企業的融資和資本流動，對經濟的發展有著重要的作用。

  相異點：
  1.  業務範圍不同：證券業的主要業務是進行股票、債券、基金等證券的發行、買賣和投資咨詢；而一般金融業則包括銀行、保險、投資、信托等多個類別，業務範圍更加廣泛。
  2.  市場定位不同：證券業主要服務對象是投資者，而一般金融業則是個人和企業的客戶。
  3.  監管機構不同：證券業主要受證監會監管，而一般金融業則受多個監管機構監管，如銀行業受央行和銀監會監管，保險業受保監會監管等。
  4.  經營模式不同：證券業以經紀人模式為主，即代理進行證券交易，從中收取佣金；而一般金融業則有多種經營模式，如銀行以存款、貸款、理財等經營，保險以承保、賠付等經營。
  5.  風險特徵不同：證券業和一般金融業所面臨的風險特徵不同。證券業風險主要集中在市場風險和信用風險，因為其業務與股票、債券等金融產品有關。而一般金融業則會面臨多種風險，如信用風險、市場風險、利率風險、流動性風險、操作風險等。
  6.  收入結構不同：證券業的收入主要來自佣金和手續費，而一般金融業的收入則來自利息差、保險費、手續費等。
  7.  競爭格局不同：證券業和一般金融業所面臨的競爭格局也不同。證券業競爭主要來自其他證券公司和券商，而一般金融業則涉及到多個類別的機構，面臨的競爭更加激烈。

  總的來說，證券業和一般金融業有著相同的金融服務提供者和市場參與者身份，但是它們的業務範圍、市場定位、監管機構、經營模式、風險特徵、收入結構和競爭格局都存在不同之處。

- 請分享1~2則您所熟知或近期關注的國內外數位金融科技或金融市場相關議題，並詳述您的觀點，並說明為何您認為這個議題值得分享。(1000字內)

  *請分享chatgpt這類生成式AI於金融科技或金融市場的應用，詳述觀點，並說明為何您認為這個議題值得分享*
  > 近來ChatGPT這類生成式AI快速崛起，在金融科技或金融市場中的應用想像也非常廣泛。ChatGPT是一種人工智能聊天機器人程序，使用基於GPT-3.5、GPT-4架構的大型語言模型並以強化學習訓練。ChatGPT目前仍以文字方式互動，也因此特別適合金融業這樣大量文字訊息來往的行業，可以透過ChatGPT來協助客戶進行投資組合管理、風險管理、財務規劃等方面的問題。此外，ChatGPT還可以協助客戶進行自動化交易、投資組合優化等方面的工作，透過以下幾點案例簡單說明相關應用場景。
  > 
  > 1. ChatGPT可以與客戶進行對話，解答客戶的問題，提供金融產品和服務的相關信息，並且可以根據客戶的需求，推薦適合的金融產品和服務。這樣可以大大提高金融機構的客戶滿意度和效率，同時也可以降低人工客服的成本。
  > 2. 在金融風險評估方面，ChatGPT可以根據大量的金融數據，進行風險評估和預測，幫助金融機構識別風險，預防風險，提高風險管理的能力。這樣可以讓金融機構更好地保護客戶的資產和利益，同時也可以降低金融機構的風險和損失。
  > 3. 在財富管理和投資建議方面，ChatGPT可以根據客戶的風險偏好和投資目標，提供個性化的財富管理和投資建議，幫助客戶實現更好的財富增長。這樣可以提高客戶對金融機構的信任和忠誠度，同時也可以提高金融機構的業務效益。並透過與推薦系統以及客戶資訊的整合，提供如真人般卻能夠達到everywhere and anytime的服務品質。
  > 
  > 這類生成式AI在金融科技或金融市場中的應用非常廣泛，可以大大提高金融機構的效率和能力(內部)，同時也可以提高客戶的滿意度和忠誠度(外部)，進而提高公司營收，不論國內外金融產業都蠢蠢欲動。因此，不論是應該主動爭取改善現有客戶體驗與內部作業流程還是因應競業透過相關科技提升競爭力，我都認為這是值得深入研究與開發的領域。

  ChatGPT這類生成式AI在金融科技或金融市場中的應用非常廣泛，它可以應用在自動客服、金融風險評估、財富管理、投資建議等方面。下面我將談談ChatGPT在這些方面的應用，以及為何這個議題值得分享。

  首先，ChatGPT在自動客服方面的應用非常廣泛。ChatGPT可以與客戶進行對話，解答客戶的問題，提供金融產品和服務的相關信息，並且可以根據客戶的需求，推薦適合的金融產品和服務。這樣可以大大提高金融機構的客戶滿意度和效率，同時也可以降低人工客服的成本。

  其次，ChatGPT在金融風險評估方面也有應用。ChatGPT可以根據大量的金融數據，進行風險評估和預測，幫助金融機構識別風險，預防風險，提高風險管理的能力。這樣可以讓金融機構更好地保護客戶的資產和利益，同時也可以降低金融機構的風險和損失。

  第三，ChatGPT在財富管理和投資建議方面也有應用。ChatGPT可以根據客戶的風險偏好和投資目標，提供個性化的財富管理和投資建議，幫助客戶實現更好的財富增長。這樣可以提高客戶對金融機構的信任和忠誠度，同時也可以提高金融機構的業務效益。

  總之，ChatGPT這類生成式AI在金融科技或金融市場中的應用非常廣泛，可以大大提高金融機構的效率和能力，同時也可以提高客戶的滿意度和忠誠度。因此，我認為這個議題值得分享。

  ChatGPT是一種人工智能聊天機器人程序，使用基於GPT-3.5、GPT-4架構的大型語言模型並以強化學習訓練。ChatGPT目前仍以文字方式互動，但在金融科技或金融市場的應用上，可以透過ChatGPT來協助客戶進行投資組合管理、風險管理、財務規劃等方面的問題。此外，ChatGPT還可以協助客戶進行自動化交易、投資組合優化等方面的工作。¹³

  ChatGPT在金融科技或金融市場的應用上，可以幫助客戶更好地理解市場趨勢和風險，並提供更好的投資建議。此外，ChatGPT還可以幫助客戶更好地管理其投資組合，並提供更好的財務規劃建議。¹³

  我認為這個議題值得分享，因為ChatGPT在金融科技或金融市場的應用上有很大的潛力，可以幫助客戶更好地理解市場趨勢和風險，並提供更好的投資建議。此外，ChatGPT還可以幫助客戶更好地管理其投資組合，並提供更好的財務規劃建議。¹³

  Source: Conversation with Bing, 29/04/2023(1) ChatGPT - 维基百科，自由的百科全书. https://zh.wikipedia.org/wiki/ChatGPT Accessed 29/04/2023.
  (2) ChatGPT 怎麼用？6 種 ChatGPT 應用方法，靠 AI 簡化工作|經理人. https://www.managertoday.com.tw/articles/view/66438 Accessed 29/04/2023.
  (3) Introducing ChatGPT. https://openai.com/blog/chatgpt Accessed 29/04/2023.
...
**策略營管組(投資顧問部-量化交易產品)**
##### 線上筆試
**測驗日期：2023/5/8(一) 15:30~15:50，測驗時間20分鐘**

**測驗連結：[https://forms.office.com/r/9Xf8zPDppU](https://forms.office.com/r/9Xf8zPDppU)**

**注意事項：**

1.  請準備可連上網路之電腦、手機或平板等相關裝置
2.  請於測驗時間開始時務必準時進入連結開始測驗，並把握時間作答，務必於上述時間結束之前送出您的測驗卷，**測驗時間一到將無法繳交/送出您的試題卷囉！(很重要~~)**
###### 筆記
![永豐金證券線上筆試.png](永豐金證券線上筆試.png "永豐金證券線上筆試.png")
[永豐金證券線上筆試.ipynb](永豐金證券線上筆試.ipynb)
<iframe width="100%" height="600px" src="保誠HoganGE測評.html"></iframe>

##### 線上面試
**面試日期：2023/5/8(一)**

**面試時間：16:10-16:20**  (請協助提早5分鐘於線上大廳等候，我們將依序邀請您進入線上會議室)

**面試主管：**投資顧問部主管及HR主管

**面試方式：**採用Microsoft Teams線上會議軟體

**面試連結：****[按一下這裡以加入會議](https://teams.microsoft.com/l/meetup-join/19%3ameeting_NjY3MzlhNDEtOTdkNy00OTJjLTg4MzMtMGY5MmE0NWU3MDZm%40thread.v2/0?context=%7b%22Tid%22%3a%22217a5a3d-163a-4e8b-af1b-58fd7f92894f%22%2c%22Oid%22%3a%22a825fbf5-b440-4c48-9fa4-7be33cf99ef5%22%7d)**

**其他說明：**

(1)連線前請您**提前確認/測試網路連線的穩定度(非常重要)**及硬體設備，麥克風、喇叭、視訊鏡頭是否皆為啟用狀態，並請以「中文姓名(全名)」登入系統。

(2)因面試人選不只一位，如您上線時顯示需等待核准，表示前一位人選尚在面試中，請您稍作等候，我們將依序邀請您進入線上會議室。

(3)面試時間僅只有10分鐘，建議您可先準備1分鐘的自我介紹，內容宜簡短扼要且邏輯清楚、切勿過於冗長或發散，把握10分鐘面試時間**(非常重要)**。

(4)面試時間雖為10分鐘，但因包含面試等待時間，故面試時間預估約需30~40分鐘，如您需安排後續行程請多加留意！

> 請問有人面永豐金證券的一階了嗎？（想知道那10分鐘問了什麼～
>
> 自介、基本問題、然後最後問一個問題
>
> 看你履歷問一些問題
...
> 感覺很隨機問
##### 準備
> *一面測驗+一對多面試每人10分鐘,[^永豐金證券MA心得-工作板|Dcard]*
>
> 面試前準備自我介紹,這部份自己可以掌握,
>
> 我把重點放在講社團經驗,實習經驗還有投資心得,結果面試官只問我投資心得,
>
> 最後再問一下我為什麼選證券業MA,答完後時間就到了。
>
> 測驗會叫你用自己的手機連到google表單作答,考數理邏輯抽象空間這些題目,沒有很難,不會寫的就猜最接近的選項,最後寫完時間剛好差不多,測驗時間忘記多久(20或30分鐘吧?)。
